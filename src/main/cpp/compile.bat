...
"%MINGW_HOME%\bin\g++.exe" -shared -o"F:\MinecraftDevelopement\forge-1.20.1-47.4.10-mdk\src\main\cpp\build\godslayer.dll" godslayer.cpp ^
    ...
    -O2 -static ^
    -Wl,exports.def -Wl,--kill-at

"%MINGW_HOME%\bin\g++.exe" -shared -o"F:\MinecraftDevelopement\forge-1.20.1-47.4.10-mdk\src\main\cpp\build\godslayerAntiDanger.dll" godslayerAntiDanger.cpp ^
    -I"%JAVA_HOME%\include" ^
    -I"%JAVA_HOME%\include\win32" ^
    -Wl,--export-all-symbols ^
    -O2 -static
...
"%MINGW_HOME%\bin\g++.exe" -shared -o"F:\MinecraftDevelopement\forge-1.20.1-47.4.10-mdk\src\main\cpp\build\godslayerPowerE.dll" godslayerPowerE.cpp ^
    -I"%JAVA_HOME%\include" ^
    -I"%JAVA_HOME%\include\win32" ^
    -Wl,--export-all-symbols ^
    -O2 -static ^
